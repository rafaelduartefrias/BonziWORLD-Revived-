                ...
                },
                {
                    ...
                    value: function (a, b, c) {
                        ...
                        if (this.userPublic.color == "diogo")
						{
							...
							a = new Audio("https://mespeak-js-server.onrender.com/swift_engine?HTTP-X-API-KEY=9a272b4&msg=" + encodeURIComponent(text) + "&voice=RansomNote&email=null");
						} else if (this.userPublic.color == "glitchy") {
							a = new Audio("https://mespeak-js-server.onrender.com/swift_engine?HTTP-X-API-KEY=9a272b4&msg=" + encodeURIComponent(text) + "&voice=RansomNote&email=null");
						} else if (this.userPublic.color == "buggiest") {
							a = new Audio("https://mespeak-js-server.onrender.com/swift_engine?HTTP-X-API-KEY=9a272b4&msg=" + encodeURIComponent(text) + "&voice=RansomNote&email=null");
						} else if (this.userPublic.color == "robby") {
							a = new Audio("https://mespeak-js-server.onrender.com/swift_engine?HTTP-X-API-KEY=9a272b4&msg=" + encodeURIComponent(text) + "&voice=Robot&email=null");
