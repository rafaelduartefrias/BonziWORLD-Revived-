            ...
            _createClass(a, [
                ...
                },
                {
                    ...
                    value: function (a, b, c) {
						...
						{
							a = new Audio("https://mespeak-js-server.onrender.com/voiceforge?text=" + encodeURIComponent(text) + "&voice=Damien");
                        } else if (this.userPublic.color == "rover") {
							a = new Audio("https://mespeak-js-server.onrender.com/voiceforge?text=" + encodeURIComponent(text) + "&voice=Dog");
                        } else if (this.userPublic.color == "god") {
							a = new Audio("https://mespeak-js-server.onrender.com/voiceforge?text=" + encodeURIComponent(text) + "&voice=Damien");
                        } else if (this.userPublic.color == "kiddie") {
							a = new Audio("https://mespeak-js-server.onrender.com/voiceforge?text=" + encodeURIComponent(text) + "&voice=Shygirl");
						} else if (this.userPublic.color == "clippy") {
							a = new Audio("https://mespeak-js-server.onrender.com/voiceforge?text=" + encodeURIComponent(text) + "&voice=Conrad"); 
						} else if (this.userPublic.color == "peedy") {
							a = new Audio("https://mespeak-js-server.onrender.com/voiceforge?text=" + encodeURIComponent(text) + "&voice=David");
						} else if (this.userPublic.color == "max") {
							a = new Audio("https://mespeak-js-server.onrender.com/voiceforge?text=" + encodeURIComponent(text) + "&voice=David");
						} else if (this.userPublic.color == "genie") {
							a = new Audio("https://mespeak-js-server.onrender.com/voiceforge?text=" + encodeURIComponent(text) + "&voice=Charlie");
						} else if (this.userPublic.color == "peedy_pope") {
							a = new Audio("https://mespeak-js-server.onrender.com/voiceforge?text=" + encodeURIComponent(text) + "&voice=Conrad");
						} else if (this.userPublic.color == "clippypope") {
							a = new Audio("https://mespeak-js-server.onrender.com/voiceforge?text=" + encodeURIComponent(text) + "&voice=Conrad");
						} else if (this.userPublic.color == "genius") {
							a = new Audio("https://mespeak-js-server.onrender.com/voiceforge?text=" + encodeURIComponent(text) + "&voice=Lawrence");
						} else if (this.userPublic.color == "merlin") {
							a = new Audio("https://mespeak-js-server.onrender.com/voiceforge?text=" + encodeURIComponent(text) + "&voice=French-fry");
						} else if (this.userPublic.color == "glitch") {
							a = new Audio("https://mespeak-js-server.onrender.com/voiceforge?text=" + encodeURIComponent(text) + "&voice=RamsomNote");
						} else if (this.userPublic.color == "glitchy") {
							a = new Audio("https://mespeak-js-server.onrender.com/voiceforge?text=" + encodeURIComponent(text) + "&voice=RamsomNote");
						} else if (this.userPublic.color == "buggiest") {
							a = new Audio("https://mespeak-js-server.onrender.com/voiceforge?text=" + encodeURIComponent(text) + "&voice=RamsomNote");
						} else if (this.userPublic.color == "robby") {
							a = new Audio("https://mespeak-js-server.onrender.com/voiceforge?text=" + encodeURIComponent(text) + "&voice=Robot");
						} else if (this.userPublic.color == "pope") {
							a = new Audio("https://mespeak-js-server.onrender.com/voiceforge?text=" + encodeURIComponent(text) + "&voice=Conrad");
						} else {
							a = new Audio("https://mespeak-js-server.onrender.com/voiceforge?text=" + encodeURIComponent(text) + "&voice=Kidaroo");
						}                        
                        a.play();
                        a.onended = function () {
                            d.clearDialog();
